...
function WorkingWithObjects() {
    ...
    return (
        <div>
            ...
            <a href={`${URL}/score/${newScore}`} className="btn btn-primary">
                Update Score
            </a>
            ...
            <a href={`${URL}/completed/${newCompleted}`} className="btn btn-primary">
                Update Completed
            </a>
            <div>
            ...
            <div>Description: {todo.description || 'No description'}</div>
            <div>Due: {todo.due || 'No due date'}</div>
                        </li>
                    ))}
                </ul>
